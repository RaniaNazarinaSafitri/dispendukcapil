    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
			<center>
			<iframe src="https://drive.google.com/file/d/1d_bjzntdNxohnbHi1NI2E_DVAKneXebT/preview" width="1000" height="2000" allow="autoplay"></iframe>
			</center>
          <div class="line">        
...
<p align="center">&raquo;Input Data KIA&laquo;</p>
<table border="0px">
			<form method="post" class="form-group" action="tambah_kia.php" enctype="multipart/form-data">
			...
			<tr><td>Nomor Kartu Keluarga</td> <td>:</td> <td><input name="no_kk" size="25" class="texbox"></td></tr>
			<tr><td>Nama Kepala Keluarga</td> <td>:</td> <td><input name="nama_kepala" size="25" class="texbox"></td></tr>
			<tr><td>Nomor Akta Kelahiran</td> <td>:</td> <td><input name="no_akta" size="25" class="texbox"></td></tr>
