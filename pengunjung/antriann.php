...
<head>
  ...
  <title>Dinas Kependudukan Lumajang </title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container" style="margin-top: 0px;">
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?php echo base_url('assets/user')?>/img/logo.png" alt=""  width="50">Antrian Pelayanan DispendukCapil Lumajang</a>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Antrian Dinas Kependudukan </small>
    </div>
  </section>
