            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?module=antrian"><i class="fa fa-table fa-fw"></i>ANTRIAN ONLINE</a>
                        </li>
                        <!-- <li>
						...
						<li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>MANAJEMEN IDENTITAS<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<!-- <li>
                                    <a href="?module=kia">MANAJEMEN KIA</a>
                                </li> -->
                                <li>
                                    <a href="?module=ktpel">MANAJEMEN KTP-EL</a>
                                </li>
							</ul>
						</li>						
                        <li>
                        ...
                        <li>
							...
							<ul class="nav nav-second-level">
								<li>
                                    <a href="?module=cetak_antrian">CETAK Antrian Online</a>
                                </li>
								<li>
                                    <a href="?module=cetak_ktpel">CETAK KTP-EL</a>
                                </li>
								<li>
